...
class Auth extends CI_Controller {
    ...
    public function login()
    {
        ...
        if ($this -> form_validation -> run() == TRUE)
        {
            ...
            $auth_data = array('username' => $this -> input -> post('username', TRUE), 'password' => $this -> input -> post('password', TRUE));
            ...
            {
                //세션 생성
                $newdata = array('username' => $result -> username, 'email' => $result -> email, 'logged_in' => TRUE);
