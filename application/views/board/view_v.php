	<!--<script type="text/javascript" src="/test/include/js/httpRequest.js"></script>-->
	<script type="text/javascript">
	$(function(){
		$("#comment_add").click(function(){
			$.ajax({
				url: "/test/ajax_board/ajax_comment_add",
				type: "POST",
				data:{
		...
		$(".comment_delete").click(function(){
			$.ajax({
				url: "/test/ajax_board/ajax_comment_delete",
				type: "POST",
				data:{
					"csrf_test_name":getCookie('csrf_cookie_name'),
					"table":"<?php echo $this->uri->segment(3);?>",
	...
	<article id="board_area">
		...
		<table cellspacing="0" cellpadding="0" class="table table-striped">
			...
			<tfoot>
				<tr>
					<th colspan="4"><a href="/test/board/lists/<?php echo $this->uri->segment(3);?>/page/<?php echo $this->uri->segment(7);?>" class="btn btn-primary">목록</a> <a href="/test/board/modify/<?php echo $this->uri->segment(3);?>/board_id/<?php echo $this->uri->segment(5);?>/page/<?php echo $this->uri->segment(7);?>" class="btn btn-warning">수정</a> <a href="/test/board/delete/<?php echo $this->uri->segment(3);?>/board_id/<?php echo $this->uri->segment(5);?>/page/<?php echo $this->uri->segment(7);?>" class="btn btn-danger">삭제</a> <a href="/test/board/write/<?php echo $this->uri->segment(3);?>/page/<?php echo $this->uri->segment(7);?>" class="btn btn-success">쓰기</a></th>
				</tr>
			</tfoot>
		</table>
